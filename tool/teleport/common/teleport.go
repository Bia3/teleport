...
func Run(options Options) (app *kingpin.Application, executedCommand string, conf *servicecfg.Config) {
	...
	joinOpenSSH.Flag("rotate", "Optionally Rotate the CA certs (update_servers, rollback)").EnumVar(&ccf.RotateOpenSSH, types.RotationPhaseUpdateServers, types.RotationPhaseRollback)
