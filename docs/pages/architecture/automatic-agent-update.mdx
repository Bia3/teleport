...
target the best version from a feature, compatbility, security and stability
point of view.

Teleport Cloud users whose instance is not automatically updated must not use
