...
processes and Proxy Service instances to join your Teleport cluster without
sharing any secrets when they are running in AWS.

<ScopedBlock scope="cloud">

The EC2 join method is not available in Teleport Enterprise Cloud. Teleport
Enterprise Cloud customers can use the [IAM join
method](./joining-nodes-aws-iam.mdx) or [secret
tokens](../admin/adding-nodes.mdx).
...
- An AWS EC2 instance to host your Teleport process, with the Teleport binary
