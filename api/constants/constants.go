...
const (
	...
	// wrapped with the Ping protocol. This should be used when the tunnelled
	// TLS Routing protocol cannot keep long-lived connections alive as L7 LB
	// usually ignores TCP keepalives and has very short idle timeouts.
